...
class TrackingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPersonaldata = channel.unary_unary(
                ...
                request_serializer=demo__pb2.TrackingRequest.SerializeToString,
                response_deserializer=demo__pb2.TrackingResponse.FromString,
                )
...
def add_TrackingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetPersonaldata': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=demo__pb2.TrackingRequest.FromString,
                    response_serializer=demo__pb2.TrackingResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class TrackingService(object):
    ...
    def GetPersonaldata(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/hipstershop.TrackingService/GetPersonaldata',
            demo__pb2.TrackingRequest.SerializeToString,
            demo__pb2.TrackingResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
