...
const (
	TrackingService_GetPersonaldata_FullMethodName = "/hipstershop.TrackingService/GetPersonaldata"
)
...
func (c *trackingServiceClient) GetPersonaldata(ctx context.Context, in *TrackingRequest, opts ...grpc.CallOption) (*TrackingResponse, error) {
	...
	err := c.cc.Invoke(ctx, TrackingService_GetPersonaldata_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TrackingService_GetPersonaldata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TrackingService_GetPersonaldata_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
